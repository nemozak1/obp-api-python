    ...
    def update(
        ...
        *,
        ...
        return self._put(
            ...
            body=maybe_transform({"branch_id": branch_id}, branch_update_params.BranchUpdateParams),
    ...
    async def update(
        ...
        *,
        ...
        return await self._put(
            f"/obp/v5.1.0/banks/{bank_id}/customers/{customer_id}/branch",
            body=await async_maybe_transform({"branch_id": branch_id}, branch_update_params.BranchUpdateParams),
            options=make_request_options(
                extra_headers=extra_headers, extra_query=extra_query, extra_body=extra_body, timeout=timeout
            ),
