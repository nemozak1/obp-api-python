    ...
    def update(
        ...
        *,
        ...
        return self._put(
            ...
            body=maybe_transform({"customer_number": customer_number}, number_update_params.NumberUpdateParams),
        ...
        *,
        ...
        return await self._put(
            ...
            body=await async_maybe_transform(
                {"customer_number": customer_number}, number_update_params.NumberUpdateParams
            ),
            options=make_request_options(
                extra_headers=extra_headers, extra_query=extra_query, extra_body=extra_body, timeout=timeout
            ),
