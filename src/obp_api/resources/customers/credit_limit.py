...
class CreditLimitResource(SyncAPIResource):
    ...
    def update(
        ...
        *,
        bank_id: str,
        credit_limit: credit_limit_update_params.CreditLimit,
        ...
        return self._put(
            ...
            body=maybe_transform({"credit_limit": credit_limit}, credit_limit_update_params.CreditLimitUpdateParams),
        ...
        *,
        ...
        return await self._put(
            ...
            body=await async_maybe_transform(
                {"credit_limit": credit_limit}, credit_limit_update_params.CreditLimitUpdateParams
            ),
            options=make_request_options(
                extra_headers=extra_headers, extra_query=extra_query, extra_body=extra_body, timeout=timeout
            ),
