    ...
    def create(
        ...
        *,
        ...
        return self._post(
            ...
            body=maybe_transform({"swagger": swagger}, dynamic_endpoint_create_params.DynamicEndpointCreateParams),
        ...
        *,
        ...
        return await self._post(
            ...
            body=await async_maybe_transform(
                {"swagger": swagger}, dynamic_endpoint_create_params.DynamicEndpointCreateParams
            ),
            options=make_request_options(
                extra_headers=extra_headers, extra_query=extra_query, extra_body=extra_body, timeout=timeout
            ),
