    ...
    def create(
        ...
        *,
        ...
        return self._post(
            ...
            body=maybe_transform({"value": value}, comment_create_params.CommentCreateParams),
    ...
    def delete(
        ...
        *,
        ...
        return self._delete(
            ...
            body=maybe_transform({"json_string": json_string}, comment_delete_params.CommentDeleteParams),
            options=make_request_options(
                extra_headers=extra_headers, extra_query=extra_query, extra_body=extra_body, timeout=timeout
            ),
            cast_to=BinaryAPIResponse,
    ...
    async def create(
        ...
        *,
        ...
        return await self._post(
            f"/obp/v5.1.0/banks/{bank_id}/accounts/{account_id}/{view_id}/transactions/{transaction_id}/metadata/comments",
            body=await async_maybe_transform({"value": value}, comment_create_params.CommentCreateParams),
            options=make_request_options(
                extra_headers=extra_headers, extra_query=extra_query, extra_body=extra_body, timeout=timeout
            ),
    ...
    async def delete(
        ...
        *,
        ...
        return await self._delete(
            f"/obp/v5.1.0/banks/{bank_id}/accounts/{account_id}/{view_id}/transactions/{transaction_id}/metadata/comments/{comment_id}",
            body=await async_maybe_transform({"json_string": json_string}, comment_delete_params.CommentDeleteParams),
            options=make_request_options(
                extra_headers=extra_headers, extra_query=extra_query, extra_body=extra_body, timeout=timeout
            ),
            cast_to=AsyncBinaryAPIResponse,
